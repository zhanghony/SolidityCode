...
contract MyNFTSwap  {
    ...
    function onERC721Received() external pure  returns (bytes4) {
        ...
        // return bytes4(abi.encodeWithSelector(IERC721Receiver.onERC721Received.selector,operator,from,tokenId,data));
    }

    // 挂单
    function sell(address nftAddress, uint256 tokenId, uint256 price) external {
