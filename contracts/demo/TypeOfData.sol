...
//     function add(UFixed256x18 a, UFixed256x18 b)
//         internal
//         pure
...
//     /// 溢出时恢复，依赖于 uint256 上的检查算术
//     function mul(UFixed256x18 a, uint256 b)
//         internal
//         pure
//         returns (UFixed256x18)
//     {
...
contract TypeOfData {
    ...
    function getString() external pure returns (string memory a) {
    ...
    //地址方法
    function demoAddress(address _addr)
        external
        view
        returns (
            uint256 balance,
